...
from models import *
from utils.CR_inp import ContrastLoss_res
...
def train(train_loader, network, criterion, optimizer, scaler):
    ...
    for batch in train_loader:
        ...
        target_img_2 = F.interpolate(target_img, scale_factor=0.5, mode='bilinear')
        ...
        with autocast(args.no_autocast):
            ...
            loss = criterion[0](output[1], target_img) + criterion[1](output[1], target_img, source_img, output[0], target_img_2) * 0.1
    ...
    if not os.path.exists(os.path.join(save_dir, args.model + '.pth')):
        ...
        for epoch in tqdm(range(setting['epochs'] + 1)):
            ...
            if epoch % setting['eval_freq'] == 0:
                ...
                # 自己加的
                print(
                    'Epoch: [{0}/{1}], Val_PSNR: {2:.2f}'
                        .format(epoch, setting['epochs'], avg_psnr)
                )
